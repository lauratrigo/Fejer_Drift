...
% ------------------------------
data = importdata('OMNI_Evento_NaN.txt');
...
% ------------------------------
dataEy = readmatrix('EyOmni5min_NaN');
...
% ------------------------------
t_start = datenum(2017,8,16,0,0,0);
t_end   = datenum(2017,8,26,23,59,59);
...
set(gca,'XTick',xticks_days, ...
    'XTickLabel', datestr(xticks_days,'dd/mm'), 'FontSize', 16);
grid on; ax=gca; ax.XMinorTick='on'; ax.MinorGridAlpha=0.5;
