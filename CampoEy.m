...
ylabel({'Vd mean';'(m/s)'},'FontSize',12);
xlim([t_start t_end]);
set(gca,'XTick',xticks_days,'XTickLabel',[]);
grid on; ax=gca; ax.XMinorTick='on'; ax.MinorGridAlpha=0.5;
...
ylabel({'Vd storm';'(m/s)'},'FontSize',12);
xlim([t_start t_end]);
set(gca,'XTick',xticks_days,'XTickLabel',[]);
grid on; ax=gca; ax.XMinorTick='on'; ax.MinorGridAlpha=0.5;
...
ylabel({'Vd total';'(m/s)'},'FontSize',12);
xlim([t_start t_end]);
set(gca,'XTick',xticks_days,'XTickLabel',[]);
grid on; ax=gca; ax.XMinorTick='on'; ax.MinorGridAlpha=0.5;
...
ylabel({'DDEF';'(m/s)'},'FontSize',12);
xlabel('Time (Days)','FontSize',18);
xlim([t_start t_end]);
set(gca,'XTick',xticks_days, ...
    'XTickLabel', datestr(xticks_days,'dd/mm'));
grid on; ax=gca; ax.XMinorTick='on'; ax.MinorGridAlpha=0.5;
